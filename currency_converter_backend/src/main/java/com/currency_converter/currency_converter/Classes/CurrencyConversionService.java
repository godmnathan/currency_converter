    ...
    public String convertCurrency(String fromCurrency, String toCurrency, double amount) {
        try {
            ...
            if (exchangeRatesResponse != null && exchangeRatesResponse.getData() != null) {
                ...
                BigDecimal convertedAmount = BigDecimal.valueOf((amount * (exchangeRateTo / exchangeRateFrom)));

                return convertedAmount.setScale(2, RoundingMode.HALF_DOWN) + " " + toCurrency;
            } else {
